function jobs=sidLoadAllJobs(jobset,subset)
% SIDLOADALLJOBS Loads all jobs specified in a jobset into cell array.
%
%    SIDLOADALLJOBS(JOBSET,SUBSET) Loads a SUBSET of jobs specified in the
...
for i=subset
  ...
  jobs{end+1} = sidLoadJob(jobset,i);
end
