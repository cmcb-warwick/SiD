function filenames=sidFindFiles(directory,regexpr,incSort,incHidden,showprog)
% SIDFINDFILES Recursively search for files by regexp.
%
%   FILENAMES = SIDFINDFILES(DIRECTORY,REGEXPR,INCSORT,INCHIDDEN,SHOWPROG)
%
...
for i=1:length(files)
  ...
  if files(i).isdir && (incHidden || currentName(1) ~= '.') ...
    ...
    filenames = [filenames; sidFindFiles(fullfile(directory,currentName),regexpr,0)];
  end
