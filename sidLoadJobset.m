function jobset=sidLoadJobset(filename)
% SIDLOADJOBSET Load jobset into struct
%
%    JOBSET = SIDLOADJOBSET(FILENAME) Loads jobset from mat-file FILENAME into
...
jobset = sidChangeJobsetDir(jobset, pathstr);
