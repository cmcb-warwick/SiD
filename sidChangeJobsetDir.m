function jobset=sidChangeJobsetDir(jobset,newpath)
% SIDCHANGEJOBSETDIR Change root directory of jobset
%
%    JOBSET = SIDCHANGEJOBSETDIR(JOBSET,NEWPATH) Changes root directory of
