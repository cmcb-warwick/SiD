...
%
% Used by the sidAnalysis function.
%
...
if opts.save
  ...
  sidLog('Saving figure: Background-corrected intensities')
...
if opts.save
  ...
  sidLog('Saving figure: Intensities normalised to cell-by-cell control channel')
...
if opts.save
  ...
  sidLog('Saving figure: Intensities normalised to spot-by-spot control channel')
