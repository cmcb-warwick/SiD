...
nn(3,:) = sum(poisson>cutoff(3))./[options.minSpots options.maxSpots];
nn(2,:) = sum(dark>cutoff(2))./[options.minSpots options.maxSpots];
nn(1,:) = sum(amp>cutoff(1))./[options.minSpots options.maxSpots];
